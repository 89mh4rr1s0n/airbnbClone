                ...
                {selectedLocation.long === result.long ? (
                    ...
                    >
                        <div className='relative h-[150px] w-[235px] rounded-2xl'>
                            <div className='absolute h-full w-full bg-gradient-to-b from-transparent to-gray-700 z-30 rounded-2xl'></div>
                            <Image
                        ...
                        <div className='absolute bottom-[10px] w-full pl-2 text-white text-semibold z-50 text-sm'>
